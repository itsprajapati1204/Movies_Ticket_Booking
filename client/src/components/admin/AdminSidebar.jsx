        ...
        {adminNavlinks.map((link, index) => (
          <NavLink
            ...
            className={({ isActive }) =>
              ...
              pl-10 first:mt-6 text-gray-400 hover:bg-primary/10 transition-all duration-200 ${
          ...
          >
            {({ isActive }) => (
              <>
                ...
                {isActive && (
                  <span className="absolute right-0 top-1/2 -translate-y-1/2 w-1.5 h-10 bg-primary rounded-l" />
                )}
              </>
            )}
          </NavLink>
